...
class MemberTable extends TableAbstract
{
    ...
    public function columns(): array
    {
        return [
            ...
            'avatar_id' => [
                'title' => trans('plugins/weborobot-dashboard::member.avatar'),
                'width' => '70px',
            ],
            'first_name' => [
    ...
    public function getBulkChanges(): array
    {
        return [
            'first_name' => [
                'title' => trans('plugins/weborobot-dashboard::member.first_name'),
                'type' => 'text',
                'validate' => 'required|max:120',
            ],
            'last_name' => [
                'title' => trans('plugins/weborobot-dashboard::member.last_name'),
                'type' => 'text',
                'validate' => 'required|max:120',
            ],
            'email' => [
