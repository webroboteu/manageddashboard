        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card login-form">
                    <div class="card-body">
                        <h4 class="text-center">{{ trans('plugins/webrobot-dashboard::member.forgot_password') }}</h4>
                        <br>
                        <form method="POST" action="{{ route('public.member.password.email') }}">
                            ...
                            <div class="form-group mb-3">
                                <input id="email" type="email"
                                       ...
                                       name="email" value="{{ old('email') }}" required placeholder="{{ trans('plugins/webrobot-dashboard::dashboard.email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group mb-0">
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('public.member.login') }}"
                                           class="btn btn-link">{{ trans('plugins/webrobot-dashboard::dashboard.back-to-login') }}</a>
                                    </div>
                            </div>
                        </form>
                    </div>
